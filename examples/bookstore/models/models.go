...
type Book struct {
	...
	Category string `json:"category" example:"programming" description:"分类" enums:"programming,fiction,science,history,other"`
...
type CreateBookRequest struct {
	...
	Category string  `json:"category" description:"分类" enums:"programming,fiction,science,history,other" default:"other"`
}
...
type UpdateBookRequest struct {
	...
	Category *string  `json:"category,omitempty" description:"分类" enums:"programming,fiction,science,history,other"`
